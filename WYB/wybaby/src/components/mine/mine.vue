<template>
  <div class="mine">
    ...
    <div class="w5">
      ...
      <div class="w51" @click="hongbao()">
        <img src="../../../img/hb.png">
        <span class="s1">我的红包</span>
        <span class="s2">></span>
      </div>
      ...
      <div class="w51" @click="help()">
        <img src="../../../img/wd.png">
        <span class="s1">使用帮助</span>
        <span class="s2">></span>
      </div>

      <div class="w51" @click="xiugai()">
        <img src="../../../img/zyap.png">
...
export default {
  ...
  methods: {
    // zhuce() {
    //   console.log("注册！"), this.$router.push({ name: "deng" });
